...
import "../src/levels/25_Motorbike/Motorbike.sol";
import "./utils/vm.sol";
...
contract MotorbikeTest is DSTest {
    ...
    function testMotorbikeHack() public {
        ...
        // implementation of the logic in the proxy
        ...
        // This can be done because the proxy contract had delegate called initialize()
        // therefore keeping the storage context of the initializer modifier bool
        // when called directly, it's as if it has never been called within its context
        engine.initialize();
