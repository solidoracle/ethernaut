...
contract AlienCodexTest is DSTest {
    ...
    function testAlienCodexHack() public {
        ...
        // LEVEL SETUP //
        /////////////////
        bytes memory bytecode = abi.encodePacked(vm.getCode("../src/leves/19_AlienCodex/AlienCodex.json"));
        address alienCodex;
        ...
        // last slot number: (2 ** 256) - 1)
        // uint(keccak256(abi.encode(1))): in which slot number the Array's first element gets stored. First because the array starts at slot number 1
        // +1 to make it overflow and get index 0
